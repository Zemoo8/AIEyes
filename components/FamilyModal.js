...
const C = {
  ...
  textMuted: 'rgba(176,168,226,0.5)',
          ...
          {loading ? (
            ...
            <>
              ...
              <View style={{ paddingHorizontal: 24, marginTop: 26 }}>
                <TouchableOpacity onPress={handleOpenDashboard} activeOpacity={0.88} style={st.primaryBtnWrap}>
                  <View style={st.primaryBtn}>
                    <Text style={st.primaryBtnTxt}>OPEN DASHBOARD</Text>
                  </View>
                </TouchableOpacity>
            ...
            <View style={st.emptyWrap}>
              ...
              <View style={{ marginTop: 20, paddingHorizontal: 24, width: '100%' }}>
                <TouchableOpacity onPress={handleGenerate} disabled={busy} activeOpacity={0.88} style={st.primaryBtnWrap}>
                  <View style={st.primaryBtn}>
                    {busy
                      ? <ActivityIndicator color="#0a0816" size="small"/>
...
const st = StyleSheet.create({
  overlay:    { flex: 1, backgroundColor: '#0a0820' },
  sheet: {
    flex: 1,
  ...
  // Code
  code: {
    color: C.textPri, fontSize: 22, fontWeight: '600',
    letterSpacing: 3,
    textAlign: 'center',
  ...
  primaryBtnTxt: {
    color: '#0a0816', fontSize: 15, fontWeight: '700', letterSpacing: 1.2,
  },
  ghostBtn: {
    marginTop: 10,
